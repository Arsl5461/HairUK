...
const FeM = () => {
  ...
  const calculations =()=>{
    ...
    if (area === "area1") {
      calculatedValue = 1900;
    } else if (area === "area12") {
      calculatedValue = 5000;
    } else if (area === "area123") {
      calculatedValue = 6750;
    } else if (area === "area1234") {
      calculatedValue = 6965;
    } else if (area === "area4") {
      calculatedValue = 2999;
    } else if (area === "area5") {
      calculatedValue = 4485;
    } else if (area === "area6") {
      calculatedValue = 2999;
    } else if (area === "area56") {
      calculatedValue = 5625;
    }
 
    navigate(`/price`, { state: { cal:calculatedValue } });
